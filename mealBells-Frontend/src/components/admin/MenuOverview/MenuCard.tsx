          ...
          <div className="flex items-center gap-2">
            {onDelete && (
              <button
                ...
                disabled={deleting}
                className="flex items-center gap-1.5 bg-red-500 hover:brightness-90 active:brightness-75 text-white text-[13px] font-semibold px-4 py-[7px] rounded-lg transition-all [font-family:var(--font-inter)] disabled:opacity-50"
              >
