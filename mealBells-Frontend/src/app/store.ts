...
import superConsumptionReducer       from "../slices/superAdmin/superAdminConsumptionSlice";
import superFoodWastageReducer       from "../slices/superAdmin/superAdminFoodWastageSlice";
import superDishReducer              from "../slices/superAdmin/superDishSlice";
import superOrganizationsReducer from "../slices/superAdmin/superAdminOrganizationSlice";
import superAdminSettingsReducer from "../slices/superAdmin/superAdminSettingsSlice";
...
export const store = configureStore({
  reducer: {
    ...
    superConsumption:       superConsumptionReducer,
    superFoodWastage:       superFoodWastageReducer,
    superDish:              superDishReducer,         
    superAdminSettings: superAdminSettingsReducer,

superOrgs: superOrganizationsReducer,
